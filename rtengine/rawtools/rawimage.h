...
protected:
  string filename; // complete filename
...
public:
  ...
  float get_ISOspeed() const {return iso_speed;}
  float get_shutter()  const {return shutter; }
...
public:
  // dcraw functions
  void scale_colors_(){ scale_colors(); }
  void pre_interpolate_() { pre_interpolate(); }
